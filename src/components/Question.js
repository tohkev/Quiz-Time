        ...
        <div className="question--block">
            ...
            <div className="question--answer">
                <div className="question--choice">
                    <input type="radio" id={`choice1-${props.id}`} value="choice1" name={props.name} className="question--radio" />
                    <label for={`choice1-${props.id}`} className="radio-label" dangerouslySetInnerHTML={{ __html: props.choice1 }}></label>
                </div>
                <div className="question--choice">
                    <input type="radio" id={`choice2-${props.id}`} value="choice2" name={props.name} className="question--radio" />
                    <label for={`choice2-${props.id}`} className="radio-label" dangerouslySetInnerHTML={{ __html: props.choice2 }}></label>
                </div>
                <div className="question--choice">
                    <input type="radio" id={`choice3-${props.id}`} value="choice3" name={props.name} className="question--radio" />
                    <label for={`choice3-${props.id}`} className="radio-label" dangerouslySetInnerHTML={{ __html: props.choice3 }}></label>
                </div>
                <div className="question--choice">
                    <input type="radio" id={`choice4-${props.id}`} value="choice4" name={props.name} className="question--radio" />
